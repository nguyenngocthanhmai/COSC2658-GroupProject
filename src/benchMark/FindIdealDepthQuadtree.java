...
public class FindIdealDepthQuadtree {
    public static void main(String[] args) {
        ...
        for (int numberOfNode : numberOfNodes) {
            ...
            for (int i = 1; i < 7; i++) {
                ...
                System.out.println("------------------------------------");
                System.out.println("Depth: " + i + ", Capacity per node: " + Map2D.calculateIdealCapacity(numberOfNode, i) + ", Time: " + (endTime - startTime) + "s, Memory: " + (runtime.totalMemory() - runtime.freeMemory()) / 1000000 + "MB");
    ...
    private static void benchmarkSearchTime(Map2D qt) {
        ...
        for (int j = 0; j < numberOfSearches; j++) {
            ...
            qt.search(searchRect, null, null, 50); // Perform the search
        ...
        System.out.println("Average search time for " + numberOfSearches + " searches: " + averageSearchTime + "ms");
    }
}
